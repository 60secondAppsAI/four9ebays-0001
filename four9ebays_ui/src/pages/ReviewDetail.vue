						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="ReviewText" type="text" placeholder="Enter ReviewText" v-model="reviewToAdd.reviewText"></base-input>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Review Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Review Text</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ReviewText" type="text" placeholder="Enter ReviewText" v-model="reviewDetails.reviewText"></input>
																		</div>
						</td>
														</tr>
															<tr> 
