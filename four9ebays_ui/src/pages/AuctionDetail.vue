						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="CurrentPrice" type="text" placeholder="Enter CurrentPrice" v-model="auctionToAdd.currentPrice"></base-input>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Current Price</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="CurrentPrice" type="text" placeholder="Enter CurrentPrice" v-model="auctionDetails.currentPrice"></input>
																		</div>
						</td>
														</tr>
															<tr> 
